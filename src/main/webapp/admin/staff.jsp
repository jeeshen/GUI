...
<%
    List<Account> accountList = AccountDB.getAllStaffsOnly();
    Account editingAccount = new Account();
%>
<html>
    <%--Manage staffs here, able to create new staff, update their info and delete staff--%>
    ...
    <body style="margin: 0">
        ...
        <dialog id="add_staff" class="modal">
            <div class="modal-box" style="width: 300px">
                <h3 class="text-lg font-bold flex justify-center">Adding New Staff</h3>
                <div class="flex justify-center">
                    <form method="post" action="${pageContext.request.contextPath}/UserServlet" onsubmit="return validateAddUser()">
                        ...
                        <button type="submit" class="btn btn-neutral w-full mt-4">Add Staff</button>
                    </form>
                </div>
            </div>
        ...
        <dialog id="edit_staff" class="modal">
            <div class="modal-box" style="width: 300px">
                <h3 class="text-lg font-bold flex justify-center">Editing Staff</h3>
                <div class="flex justify-center">
                    <form method="post" action="${pageContext.request.contextPath}/UserServlet" onsubmit="return validateEditProduct()">
                        ...
                        <button type="submit" class="btn btn-neutral w-full mt-4">Update Staff</button>
                    </form>
                </div>
            </div>
            <form method="dialog" class="modal-backdrop">
        ...
        %>
        <dialog id="delete_staff" class="modal">
            <div class="modal-box" style="width: 350px">
                <h3 class="text-lg font-bold flex justify-center">Staff Delete Confirmation</h3>
                <div class="flex justify-center">
                    <form method="post" action="${pageContext.request.contextPath}/UserServlet">
                        ...
                        <button type="submit" class="btn btn-neutral w-full mt-4">Delete Staff</button>
                    </form>
                </div>
            </div>
            <form method="dialog" class="modal-backdrop">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="text-gray col-span-4 justify-left text-md">
                            <a onclick="add_staff.showModal()" class="flex items-center">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                edit_staff.showModal();
                <% } %>

                <% if (action.equals("delete")) { %>
                delete_staff.showModal();
                <% } %>
            });
