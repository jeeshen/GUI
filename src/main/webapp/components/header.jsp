...
<div class="flex justify-between mb-10">
    ...
    <div class="flex my-8 justify-evenly w-70">
        ...
        <div class="dropdown dropdown-end flex items-center">
            ...
            <ul tabindex="0" class="menu dropdown-content bg-base-200 rounded-box z-10 mt-4 w-52 p-2 shadow-sm">
                <li class="w-full"><a href="orders.jsp" class="whitespace-nowrap w-full">Orders</a></li>
                <li class="w-full"><a href="${pageContext.request.contextPath}/LogoutServlet" class="whitespace-nowrap w-full">Logout</a></li>
            </ul>
        </div>
        <% } %>
    </div>
