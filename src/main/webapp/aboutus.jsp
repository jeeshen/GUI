...
<html>
    ...
    <body class="bg-base-100 pb-20 mb-50">
        ...
        <p class="mt-20 w-[85%] text-black-400 font-inter text-5xl pl-100">We believe that everyone deserves access to<br>
            high-quality mobile devices, empowering them to stay connected, express themselves, and explore endless possibilities.
        <p class="mt-20 w-[85%] text-black-400 font-inter text-5xl pl-100">Through exceptional service and trusted expertise, we bring the world closer—one phone at a time.</p>
    </body>
</html>