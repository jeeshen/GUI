...
<%@ page import="main.Cart, main.Product, java.util.Map" %>
<%@ page session="true" %>
<html>
        ...
        <div class="flex gap-10 mx-30">
            <div class="w-1/2 bg-base-200 p-10 rounded-lg">
                ...
                <%
                    ...
                    if (items.isEmpty()) {
                %>
                <p class="text-xl">Cart is empty. Add some products to checkout.</p>
                <% } else { %>
                <table class="table">
                    <thead>
                    <tr>
            ...
            <div class="w-1/2 bg-base-200 p-10 rounded-lg">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>6% SST (RM)</th>
                        <td><%=cart.calculateTotal() * 0.06 %></td>
                    </tr>
                    <tr>
                        <th class="text-lg">Total Price (RM)</th>
                        <td><%=cart.calculateTotal() + 7 + cart.calculateTotal() * 0.06%></td>
                    </tr>
                </table>
            </div>
            <% } %>
